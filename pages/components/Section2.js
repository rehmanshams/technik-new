...
const Section2 = () => {
    return (
        <div>
            ...
            <div className='absolute container sm:max-w-full md:max-w-full lg:max-w-full xl:max-w-full 2xl:max-w-full 4xl:max-w-full w-full  h-[896px]    sm:mt-[-150px] md:mt-[-300px] lg:mt-[120px] xl:mt-[120px]  2xl:mt-[120px] 4xl:mt-[120px] bg-gray-100'>
                <div className='2xl:ml-24'>
                    <p className='mt-[120px] text-4xl leading-[120%] font-bold text-center'>What We Do Best?</p>
                    <p className='font-normal leading-[150%] mt-3 sm:text-[12px] md:text-sm lg:text-base xl:text-base  4xl:text-base 2xl:text-base text-center ml-[27px] text-[#2D2D2D]'>You want to build a renewable energy power plant <span className='font-bold'>(Wind, PV, Biogas)</span> and want to earn money with it.<br></br>
                ...
                <div className='flex justify-center 2xl:ml-44 mt-[60px] sm:gap-4  md:gap-6 lg:gap-6 xl:gap-6 2xl:gap-6'>
                    <div className='lg:w-[230px] sm:w-[180px] md:w-[230px] xl:w-[330px] 2xl:w-[330px] bg-white lg:h-[260px] xl:h-[366px] 2xl:h-[366px]'>
                        <img className='mt-3 ml-3 sm:w-[157px] md:w-[207px] lg:w-[207px] xl:w-[307px] 2xl:w-[307px] mr-3' src='https://tuk-cdn.s3.amazonaws.com/can-uploader/Frame+812932.svg'></img>
                        <div>

                            <p className='font-semibold mt-4 sm:text-sm md:text-base lg:text-base xl:text-base 2xl:text-base 4xl:text-base text-center text-[#2D2D2D]'>Electrical planning</p>
                        </div>
                    </div>
                    <div className='lg:w-[230px] sm:w-[180px] md:w-[230px] xl:w-[330px] 2xl:w-[330px] bg-white lg:h-[260px] xl:h-[366px] 2xl:h-[366px]'>
                        <img className='mt-3 ml-3 sm:w-[157px] md:w-[207px] lg:w-[207px] xl:w-[307px] 2xl:w-[307px] mr-3' src='https://tuk-cdn.s3.amazonaws.com/can-uploader/Frame%20812932%20%281%29.svg'></img>
                        <div>

                            <p className='font-semibold mt-4 sm:text-sm md:text-base lg:text-base xl:text-base 2xl:text-base 4xl:text-base text-center text-[#2D2D2D]'>Energy control center</p>
                        </div>
                    </div>
                    <div className='lg:w-[230px] sm:w-[180px] md:w-[230px] xl:w-[330px] 2xl:w-[330px] bg-white lg:h-[260px] xl:h-[366px] 2xl:h-[366px]'>
                        <img className='mt-3 ml-3 sm:w-[157px] md:w-[207px] lg:w-[207px] xl:w-[307px] 2xl:w-[307px] mr-3' src='https://tuk-cdn.s3.amazonaws.com/can-uploader/Frame%20812932%20%282%29.svg'></img>
                        <div>

                            <p className='font-semibold mt-4 sm:text-sm md:text-base lg:text-base xl:text-base 2xl:text-base 4xl:text-base text-center text-[#2D2D2D]'>DEA regulation</p>
                        </div>
                    </div>
                </div>
