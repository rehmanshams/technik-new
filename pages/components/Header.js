...
const Header = () => {
    ...
    return (
        <div className='w-full  max-w-[1920px] h-full mx-auto'>
            <div className='flex  absolute justify-between w-full items-center'>
                <div className='  md:max-w-[91px]  lg:max-w-[141px] xl:max-w-[141px] 4xl:max-w-[141px] 2xl:max-w-[141px] w-full h-12 xs:ml-5 md:ml-10 lg:ml-16 xl:ml-20 2xl:ml-20 mt-4'>
