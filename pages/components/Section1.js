        ...
        <div className='w-full max-w-[1920px] h-full mx-auto '>
            ...
            <div className='w-full xl:[1280px] 2xl:max-w-[1615px] absolute lg:mt-[201px] xl:mt-[281px] 2xl:mt-[281px] lg:pl-16 xl:pl-16 2xl:pl-0 2xl:ml-[237px] '>
                ...
                <div className='max-w-[500px] w-full  h-[81px]'>
                    <p className='   lg:mt-1 xl:mt-6 2xl:mt-6  lg:text-sm xl:text-lg 2xl:text-lg leaing-[150%]  font-normal font-camp'>
                ...
                <div className='lg:w-[186px] xl:w-[266px] 2xl:w-[266px] lg:h-[49px] xl:h-[59px] 2xl:h-[59px] bg-[#00828C] mt-8 flex justify-center'>
                    <button className='font-medium text-white text-camp lg:text-sm xl:text-lg 2xl:text-lg leading-[150%]'>Connect me to the grid</button>
                </div>
            ...
            <div className=' w-full 2xl:ml-[200px] lg:max-w-[750px] xl:max-w-[980px] 2xl:max-w-[1467px]  h-full float-right bg-gray-100'>
                ...
                <div className='flex float-right'>
                    ...
                    <img className='mt-[136px] w-full lg:max-w-[250px]  xl:max-w-[350px] 2xl:max-w-[436px] max-h-[662px] h-full mr-10' src='https://tuk-cdn.s3.amazonaws.com/can-uploader/Rectangle+2.svg'></img>
                    <img className='mt-[100px] w-full lg:max-w-[160px] 2xl:max-w-[400px] xl:max-w-[220px]' src='https://tuk-cdn.s3.amazonaws.com/can-uploader/Rectangle%203.svg'></img>
                </div>
                <div className='grid-container cursor-pointer lg:mt-[520px] xl:mt-[670px] 2xl:mt-[800px] bg-inherit'>
