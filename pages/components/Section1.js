        ...
        <div className='w-full max-w-[1920px] h-full mx-auto '>
            ...
            <div className=' w-full ml-[200px] max-w-[1467px]  h-full float-right bg-gray-100'>
                ...
                <div className='flex float-right'>
                    <button className='arrow-button mt-[640px]'><img className='flex w-6 h-6 justify-center mr-1' src='https://tuk-cdn.s3.amazonaws.com/can-uploader/Arrow_Left_5.svg'></img></button>
                ...
                <div className='grid-container cursor-pointer mt-[800px] bg-inherit'>
